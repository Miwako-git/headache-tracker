...
3. Copy the entire code from [`code.gs`](./code.gs) and [`index.html`](./index.html) in this repository and paste each into the editor
...
2. このリポジトリの [`code.gs`](./code.gs) と [`index.html`](./index.html) にあるコードをそれぞれ**まるごとコピーして貼り付ける**
