...
If you suffer from migraines, check out our YouTube channel Beyond Gravity.
We offer brown noise and dark ambient tracks with frequencies filtered above 6000Hz — specifically designed for sensory-sensitive listeners.
...
偏頭痛に悩んでいる方へ。自身のYouTubeチャンネル Beyond Gravity では、ブラウンノイズやダークアンビエントを配信しています。
6000Hz以上をカットした低周波設計で、感覚過敏の方にも優しい音響空間です。
174Hzヒーリングトーン、ブラウンノイズ、宇宙映像で、辛いときに少しでも楽になれますように。
🔗 [Beyond Gravity (YouTube)](https://www.youtube.com/@Beyond-DeepGravity)
