...
2. Paste your Web app URL into the address bar and tap **Go**
...
7. デプロイ完了後に表示される **ウェブアプリのURL** をコピーして保存しておく
...
2. アドレスバーに先ほどのURLを貼り付けて **「開く」** をタップ
...
1. Safari 下部の **共有ボタン**（四角から矢印が出ているアイコン **⬆**）をタップ
