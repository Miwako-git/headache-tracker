...
<img src="images/step2-extensions-menu.png" width="600">
...
<img src="images/step3-editor-blank.png" width="600">

2. **Select all of it and delete it**
3. Copy the entire code from [`Code.gs`](./Code.gs) and paste it into the editor. Then click the **"+" button** on the top left to add a new file, and paste the code from [`index.html`](./index.html) the same way
4. Paste it into the editor — it should look like this:

<img src="images/step3-editor-pasted.png" width="600">
...
<img src="images/step4-deploy-settings.png" width="600">
...
<img src="images/step4-deploy-complete.png" width="600">
...
<img src="images/step5-safari-open.jpg" width="234">
...
<img src="images/step5-safari-share.png" width="234">

2. Scroll down and tap **"Add to Home Screen"**

<img src="images/step6-add-to-home.png" width="234">

3. Give it a name (e.g. `Migraine Tracker`) and tap **"Add"**
4. The icon will now appear on your iPhone home screen 🎉

<img src="images/step6-home-screen.png" width="234">
...
2. このリポジトリの [`Code.gs`](./Code.gs) にあるコードを**まるごとコピーして貼り付ける**。次に左上の **「+」ボタン** から新規ファイルを追加し、[`index.html`](./index.html) のコードも同様に貼り付ける
